...
- MCP_TIMEOUT 환경 변수를 사용하여 MCP 서버 시작 시간 초과 구성 (예: `MCP_TIMEOUT=10000 claude`는 10초 시간 초과 설정)
...
Claude Desktop에서 이를 사용하려면 claude_desktop_config.json에 다음 구성을 추가하세요:
