const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./shared-auth-Cd5MVtjC.js","./seoulsurvival-i18n-CiaOUQQV.js","./shared-common-BL0bCyN7.js","./shared-common-djr7mLKU.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as C,i as b,d as v}from"./shared-common-BL0bCyN7.js";import{_}from"./seoulsurvival-i18n-CiaOUQQV.js";import"./shared-auth-Cd5MVtjC.js";function f(c,u="info"){const o=document.createElement("div");o.textContent=c,o.style.cssText=`
    position: fixed;
    bottom: 20px;
    left: 50%;
