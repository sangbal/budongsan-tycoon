const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./shared-auth-BKtGvxPA.js","./seoulsurvival-i18n-fm0rBIgf.js","./shared-common-DfC9Yjef.js","./shared-common-YLoqXgoP.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as C,i as b,d as v}from"./shared-common-DfC9Yjef.js";import{_}from"./seoulsurvival-i18n-fm0rBIgf.js";import"./shared-auth-BKtGvxPA.js";function f(c,u="info"){const o=document.createElement("div");o.textContent=c,o.style.cssText=`
    position: fixed;
    bottom: 20px;
    left: 50%;
