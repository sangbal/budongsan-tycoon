import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as u,d as m,b as f}from"./shared-common-P0-icqZ5.js";import{g as v}from"./patchnotes.registry-FKfJoHun.js";import"./seoulsurvival-i18n-CFcB2WGI.js";import"./shared-auth-BaZ6Nda7.js";const y={feature:"category-feature",fix:"category-fix",balance:"category-balance",ui:"category-ui",content:"category-content",performance:"category-performance"},h={feature:{ko:"기능",en:"Feature"},fix:{ko:"수정",en:"Fix"},balance:{ko:"밸런스",en:"Balance"},ui:{ko:"UI",en:"UI"},content:{ko:"콘텐츠",en:"Content"},performance:{ko:"성능",en:"Performance"}};function c(){const a=document.getElementById("patchnotes-container");if(!a)return;const e=localStorage.getItem("clicksurvivor_lang")||"ko";let o=v("seoulsurvival");if(o=o.sort((t,r)=>new Date(r.date)-new Date(t.date)),o.length===0){a.innerHTML=`
