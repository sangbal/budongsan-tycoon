const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./shared-auth-DE7HrYGc.js","./seoulsurvival-i18n-CiaOUQQV.js","./shared-common-Gi3XBguc.js","./shared-common-CWkCve-z.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as C,i as b,d as v}from"./shared-common-Gi3XBguc.js";import{_}from"./seoulsurvival-i18n-CiaOUQQV.js";import"./shared-auth-DE7HrYGc.js";function f(c,u="info"){const o=document.createElement("div");o.textContent=c,o.style.cssText=`
    position: fixed;
    bottom: 20px;
    left: 50%;
