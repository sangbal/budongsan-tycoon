const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./shared-auth-B18utKuL.js","./seoulsurvival-i18n-CHedcszT.js","./shared-common-By_9TMSh.js","./shared-common-CWv3kcCD.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";import{e as C,i as b,f as v}from"./shared-common-By_9TMSh.js";import{_}from"./seoulsurvival-i18n-CHedcszT.js";import"./shared-auth-B18utKuL.js";function f(c,u="info"){const o=document.createElement("div");o.textContent=c,o.style.cssText=`
    position: fixed;
    bottom: 20px;
    left: 50%;
