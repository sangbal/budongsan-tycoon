const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./shared-auth-C9CeeEy7.js","./seoulsurvival-i18n-BhWfeawF.js","./shared-common-BZrEzGEi.js","./shared-common-YLoqXgoP.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as C,i as b,d as v}from"./shared-common-BZrEzGEi.js";import{_}from"./seoulsurvival-i18n-BhWfeawF.js";import"./shared-auth-C9CeeEy7.js";function f(c,u="info"){const o=document.createElement("div");o.textContent=c,o.style.cssText=`
    position: fixed;
    bottom: 20px;
    left: 50%;
