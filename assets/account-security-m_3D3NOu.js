const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./shared-auth-BS6hMw4s.js","./seoulsurvival-i18n-z3sVIM_M.js","./shared-common-Bh-ahcVH.js","./shared-common-0_VAKT2z.css"])))=>i.map(i=>d[i]);
import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as C,i as b,d as v}from"./shared-common-Bh-ahcVH.js";import{_}from"./seoulsurvival-i18n-z3sVIM_M.js";import"./shared-auth-BS6hMw4s.js";function f(c,u="info"){const o=document.createElement("div");o.textContent=c,o.style.cssText=`
    position: fixed;
    bottom: 20px;
    left: 50%;
